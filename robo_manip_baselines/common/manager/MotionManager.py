...
class MotionManager:
    ...
    def get_measured_data(self, key, obs):
        ...
        elif key == DataKey.MEASURED_OBJECT_POSE:
            return self.env.unwrapped.get_object_pose()
        elif key == DataKey.MEASURED_GOAL_POSE:
            return self.env.unwrapped.get_goal_pose()
        else:
            raise ValueError(
